...
public class ConstantRun {
	 ...
	 * 	- static final 키워드를 붙여서 프로그램 시작과 동시에 static의 상수 메모리에 올려두고 공유하면서
	 * 	 사용하였다.
	 * 	- 상수명은 항상 대문자로 작성한다.
	 * 
	 * 상수의 단점
	 * 	- 비슷한 의미를 가진 값들 여러개를 저장하고자 할때 하나의 상수에 담을 수 없다. 
	 * 	- 담긴 값에 대한 검증기능이 없다.
	 * */
	...
	public static void main(String[] args) {
		...
		Car tesla = new Car();
		tesla.setName("테슬라");
		//tesla.setColor(CarColor.BLACK);; // 0 == 검은색, 1 == 빨강, 2 == 파랑
		tesla.setColor(Calendar.YEAR);; // 0 == 검은색, 1 == 빨강, 2 == 파랑
		// 값에 대한 검증기능이 부재.
		// 제대로 쓴다면 상관 없지만, 복잡한 프로그래밍 도중 이상한 상수값을 사용하는 경우 실제 동작시 무제가 생길
		// 수도 있다.
