...
// enum도 동일한 class이며, 상수 열거형 데이터들을 간결한 문법을 다루기위해 자바에서 제공하는 클래스.
public enum CarColor {
	...
	public static CarColor valueOf(int color) {
		// CarColor의 필드값을 통해 원하는 Enum 객체 찾기
		...
		return Arrays.stream(enums)
			...
			.findAny() // 찾고자하는 값이 있다면 그것을 반환
			.orElse(null); // 없다면 null반환
		
	}
	
	// enum을 통해 각 상수값이 고유한 기능을 가질 수 있도록 구현 가능.
