...
public class LamdaPractice {
	...
	public static void main(String[] args) {
		...
		// 4. 중괄호 생략하기
		// 	  단, 실행할 코드가 "한문장"인 경우 메소드중괄호 생략 가능. 
		LamdaTest2 lamda4 = x -> System.out.println(x);
	
		// 5. return생략하기 :  실행할 코드가 return값 뿐이라면 생략이 가능.
		// -> 뒤쪽에 코드 실행후 값을 반환시키라는 의미가 담겨있다.
		//	따라서 return이 두 번 들어가는 경우 의미가 이상해진다.
		LamdaTest1 lamda5 = (x, y) -> x+y;
		
		/*
		 * 람다식 정리
		 * 	- 람다식의 간소화 문법은 필수로 사용해야하는 것은 아니나, 사용자의 취향에 따라
		 * 	  모두 자주 사용되는 표현법들이기 때문에 사용방법에 대한 연습이 필요하다.
		...
		// 1. x -> x * x;
		Practice1 p = x -> x * x; /*new Practice1() {
