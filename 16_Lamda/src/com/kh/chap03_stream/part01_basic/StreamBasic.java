...
public class StreamBasic {
	 ...
	 * 	 즉, 배열이아 컬렉션 내부의 값만 깊은 복사하여 가져온다.
	 * */
	...
	public static void main(String[] args) {
		...
		// 5) iterate(초기값, UnrayOperator) : 초기값과 초기값을 다루는 람다식(UnaryOperator)을 작성하여
		...
		// ## 위 코드를 스트림을 통해 구현하기. ##
		// 데이터들중 4의 배수인 값들만 필터링 한 후 그값들의 합을 구한다.
		...
		IntStream stream4 = stream3.peek(i -> System.out.println("최종 i의 값"+i));
		
		// 최종연산 메서드
		int sSum = stream4.sum(); // 중간연산을 실행시키는 트리거의 역할을 ㅎ마.
		//int sSum2 = stream4.sum(); // 스트림은 재사용이 불가능하다.
		System.out.println("스트림을 통한 연산 결과 :"+sSum);
